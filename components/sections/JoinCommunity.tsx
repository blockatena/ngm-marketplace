...
function JoinCommunity(): ReactElement {
  return (
    <section className="py-16 lg:py-24  px-[5%] 2xl:px-[12%] grid place-items-center text-white bg-gradient-to-tr from-[#4315A5] to-[#E26C1A]">
      ...
      <p className="lg:text-[1.25rem] leading-[1.875rem] font-poppins max-w-[29.8125rem] text-center my-6">
        We the community at GamesToWeb3 have our own discord group consisting of
        150+ members. Be a part of it.
      </p>
