    ...
    <div>
      <main className="p-4 pt-6 lg:px-16">
        <h6 className="mb-4 text-sm md:text-lg font-poppins">
          <span className="text-gray-300 cursor-pointer">Home</span>{' '}
        ...
        >
          <div className="h-56 rounded-lg bg-custom_purple opacity-50 w-full lg:w-2/5 grid place-items-center">
